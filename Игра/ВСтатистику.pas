...
s:=Memo.Lines[j];
While copy(s,1,1)<>'.' do begin  delete(s,1,1); end;       //Находим порядковый номер игрока.
...
if (way<>'\ОчистилиПоле.txt') and (Memo.Lines.Count-1>14) then begin memo.Lines.Delete(Memo.Lines.Count-1); end;
